...
| File | Description |
|------|-------------|
| `LEARNING_PATH.md` | **1,326 lines** — Registry persistence deep dive, path obfuscation, 2 YARA rules, Sigma rule, 3 Python scripts, Sysmon config, defense hardening guide, 10 exercises, adversarial challenges |
