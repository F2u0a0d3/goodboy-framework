...
| [**15**](stage-15-c2-agent/) | **C2 Agent** | Full C2 with encrypted HTTPS beaconing, browser-gate, 9 commands, PRNG key derivation, mock C2 server | 1,636 | Released |
...
| Total learning content | 19,000+ lines |
| Exercises | 65+ hands-on |
| YARA rules | 20+ (with adversarial countermeasures) |
| Sigma rules | 9+ (behavioral detection) |
| Python scripts | 28+ (solvers, scanners, crypto tools) |
...
- No network activity (except Stage 15 which beacons to a non-existent IP), no persistence, no system modifications
